local L = LibStub("AceLocale-3.0"):NewLocale("Brannfred_Spells", "deDE")
...
L["Close the search frame when dragging to the action bar"] =
"Schließt das Suchfenster beim Ziehen auf die Aktionsleiste"
